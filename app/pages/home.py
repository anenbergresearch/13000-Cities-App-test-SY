        ...
        [
            dbc.AccordionItem(
                [
                    ...
                    - Version 2 PM<sub>2.5</sub> urban concentrations are from [Kim et al. (2025)]. PM<sub>2.5</sub> concentrations are from [van Donkelaar et al. (2021)](https://pubs.acs.org/doi/10.1021/acs.est.1c05309), which estimates annual average concentrations at 0.01° (~ 1 km) resolution, combining satellite remote sensing of aerosol optical depth, a chemical transport model, and ground-based measurements.
                    ...
                    - Version 2 CO<sub>2</sub> urban emissions are from [Kim et al. (2025)]. CO<sub>2</sub> emissons are from annual sector-specific emission datasets of the [EDGAR v8.0](https://edgar.jrc.ec.europa.eu/report_2023), which has 0.1° (~ 10 km) resolution with global coverage.
